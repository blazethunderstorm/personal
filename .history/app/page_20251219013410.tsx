...
import { Github, Mail, ExternalLink, Star, GitFork, ArrowUpRight, Sparkles, ChevronRight, Code2, Database, Globe, Cpu, Box, Layers } from 'lucide-react';
...
const PortfolioWebsite = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => setIconsLoaded(true), 100);
  ...
  const floatingIcons = [
    { Icon: Code2, color: 'from-orange-500 to-red-500', size: 80, position: { top: '10%', left: '5%' }, delay: 0 },
    { Icon: Database, color: 'from-orange-500 to-yellow-500', size: 70, position: { top: '25%', left: '10%' }, delay: 0.1 },
    { Icon: Globe, color: 'from-yellow-500 to-orange-400', size: 60, position: { top: '45%', left: '8%' }, delay: 0.2 },
    { Icon: Layers, color: 'from-green-500 to-green-600', size: 75, position: { bottom: '35%', left: '12%' }, delay: 0.3 },
    { Icon: Box, color: 'from-green-400 to-teal-500', size: 65, position: { bottom: '15%', left: '6%' }, delay: 0.4 },
    { Icon: Cpu, color: 'from-gray-600 to-gray-700', size: 70, position: { top: '15%', right: '8%' }, delay: 0.5 },
    { Icon: Code2, color: 'from-purple-500 to-purple-600', size: 85, position: { top: '35%', right: '5%' }, delay: 0.6 },
    { Icon: Database, color: 'from-blue-500 to-blue-600', size: 75, position: { bottom: '45%', right: '10%' }, delay: 0.7 },
    { Icon: Globe, color: 'from-cyan-500 to-blue-500', size: 65, position: { bottom: '20%', right: '7%' }, delay: 0.8 },
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        {floatingIcons.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`absolute ${iconsLoaded ? 'animate-icon-enter' : 'scale-0 opacity-0'}`}
              style={{
                ...item.position,
            ...
            >
              <div 
                className={`rounded-3xl bg-gradient-to-br ${item.color} p-6 shadow-2xl animate-float-slow backdrop-blur-sm`}
                style={{
                  width: `${item.size}px`,
                  height: `${item.size}px`,
              ...
              >
                <IconComponent className="w-full h-full text-white opacity-90" />
              </div>
            </div>
          );
        })}
      ...
      {/* Skills */}
      <section id="about" className="py-32 px-6 border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto">
      ...
      {/* Contact */}
      <section id="contact" className="py-32 px-6 border-t border-white/5 relative z-10">
        <div className="max-w-7xl mx-auto">
      ...
      <style>{`
        ...
        .animate-icon-enter {
          animation: icon-enter 1s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
        }
        .animate-float-slow { 
